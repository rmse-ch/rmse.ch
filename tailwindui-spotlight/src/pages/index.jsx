...
export default function Home({ articles }) {
  return (
    <>
      <Head>
        <title>
          Rico Metzger - Software Engineer, Freelancer, Motorcyclist
        </title>
        <meta
          name="description"
          content="I'm Rico, a software developer / engineer working as a freelancer based in Thunstetten, Switzerland. I enjoy developing solutions for business needs, while also embracing the functional style of programming."
        />
      </Head>
